...
- **[`antigravity/`](antigravity/README.md)** — Rust binary hook (`rtk hook antigravity`), init script (`init.sh`), `PreToolUse` lifecycle hook in `hooks.json` (workspace or global), `overwrite.CommandLine` rewrite
